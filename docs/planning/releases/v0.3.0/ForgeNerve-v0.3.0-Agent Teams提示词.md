# ForgeNerve v0.3.0 Agent Teams 提示词

> 目标版本: v0.3.0
> 日期: 2026-04-09
> 文档类型: Agent Teams 提示词
> 状态: 待定稿
> 关联文档:
...
1. `docs/planning/releases/v0.3.0/ForgeNerve-v0.3.0-差异化战略.md`
2. `docs/planning/releases/v0.3.0/ForgeNerve-v0.3.0-产品需求文档.md`
3. `docs/planning/releases/v0.3.0/ForgeNerve-v0.3.0-决策冻结清单.md`
4. `docs/planning/releases/v0.3.0/ForgeNerve-v0.3.0-数据模型与状态机.md`
5. `docs/planning/releases/v0.3.0/ForgeNerve-v0.3.0-MCP契约矩阵.md`
6. `docs/planning/releases/v0.3.0/ForgeNerve-v0.3.0-依赖矩阵.md`
7. `docs/planning/releases/v0.3.0/ForgeNerve-v0.3.0-Sprint1任务拆解.md`
8. `docs/planning/releases/v0.3.0/ForgeNerve-v0.3.0-Sprint1验收矩阵.md`
...
```text
创建一个 agent team 来实现 ForgeNerve v0.3.0 的第一阶段能力，目标是建立 Inbox + Session + Verified Draft 的最小闭环，并为后续 Reliability 与 Context Pack 打基础。
