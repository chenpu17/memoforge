...
> - [ForgeNerve-v0.3.0桌面接口冻结表](./ForgeNerve-v0.3.0-%E6%A1%8C%E9%9D%A2%E6%8E%A5%E5%8F%A3%E5%86%BB%E7%BB%93%E8%A1%A8.md)
> - [Agent协作增强与MCP精简方案（归档）](../../archive/Agent协作增强与MCP精简方案.md)
> - [Tauri桌面应用增强开发计划（归档）](../../archive/Tauri桌面应用增强开发计划.md)
...
v0.3.0 不建议让 Agent 直接面对过多散乱工具，而是新增更高层抽象：
...
- 在实现前先冻结状态机与字段定义
- 以 `ForgeNerve-v0.3.0-数据模型与状态机.md` 为唯一事实源
