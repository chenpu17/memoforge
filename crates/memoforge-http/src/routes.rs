...
pub fn create_router(state: AppState) -> Router {
    // Create rate limiter
    let rate_limiter =
        RateLimiter::new(state.config.rate_limit, state.config.rate_limit_window_secs);
    ...
    let public_routes = Router::new()
        ...
        .route(
            "/api/knowledge/item",
            get(handlers::get_knowledge_item_handler),
        )
        .route(
            "/api/knowledge/stale",
            get(handlers::get_knowledge_stale_item_handler),
        )
        .route(
            "/api/knowledge/link-completions",
            get(handlers::complete_knowledge_links_handler),
        )
        .route(
            "/api/knowledge/delete-preview",
            get(handlers::preview_delete_knowledge_item_handler),
        )
        ...
        .route(
            ...
            get(handlers::get_backlinks_item_handler),
        )
        .route(
            "/api/knowledge/related",
            get(handlers::get_related_item_handler),
        )
        .route("/api/knowledge/{id}", get(handlers::get_knowledge_handler))
        .route(
            "/api/knowledge/{id}/stale",
            get(handlers::get_knowledge_with_stale_handler),
        )
        .route(
            "/api/knowledge/{id}/delete-preview",
            get(handlers::preview_delete_knowledge_handler),
        )
        .route("/api/knowledge/{id}/move", options(preflight_ok))
        .route("/api/knowledge/{id}/move-preview", options(preflight_ok))
        .route(
            "/api/knowledge/{id}/backlinks",
            get(handlers::get_backlinks_handler),
        )
        .route(
            "/api/knowledge/{id}/related",
            get(handlers::get_related_handler),
        )
        .route(
            "/api/knowledge/graph",
            get(handlers::get_knowledge_graph_handler),
        )
        ...
        .route(
            ...
            get(handlers::get_tags_with_counts_handler),
        )
    ...
    let protected_routes = Router::new()
        ...
        .route(
            "/api/knowledge/item",
            put(handlers::update_knowledge_item_handler),
        )
        .route(
            "/api/knowledge/item",
            delete(handlers::delete_knowledge_item_handler),
        )
        .route(
            "/api/knowledge/move",
            post(handlers::move_knowledge_item_handler),
        )
        .route(
            "/api/knowledge/move-preview",
            post(handlers::preview_move_knowledge_item_handler),
        )
        .route(
            "/api/knowledge/{id}",
            put(handlers::update_knowledge_handler),
        )
        .route(
            "/api/knowledge/{id}",
            delete(handlers::delete_knowledge_handler),
        )
        .route(
            "/api/knowledge/{id}/move",
            post(handlers::move_knowledge_handler),
        )
        .route(
            "/api/knowledge/{id}/move-preview",
            post(handlers::preview_move_knowledge_handler),
        )
        .route("/api/categories", post(handlers::create_category_handler))
        .route(
            "/api/categories/{id}",
            put(handlers::update_category_handler),
        )
        .route(
            "/api/categories/{id}",
            delete(handlers::delete_category_handler),
        )
        ...
        .route(
            "/api/import/preview",
            post(handlers::preview_import_handler),
        )
